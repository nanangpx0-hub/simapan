...
test('role non-admin tidak memiliki permission admin audit maupun master manage', function (): void {
    $denied = ['admin.user.manage', 'admin.role.manage', 'audit.view', 'master.work_unit.manage', 'master.survey_type.manage', 'master.survey_period.manage', 'master.region.manage', 'master.officer.manage', 'allocation.view', 'allocation.manage', 'allocation.assign', 'dsrt.view', 'dsrt.manage', 'dsrt.verify', 'document.view', 'document.manage', 'document.receive', 'document.assign'];
